                        ...
                        while(!done)
                        {
                            ...
                            switch(input) {
                                case ONE:
                                    ...
                                    if(!line.equals(BACK))
                                    {
                                        ResultSet rs = dbq.getWeeklyPlanId(plan, uc.getUser());
                                        if (rs.next()) {
                                            plan.setName(line);
                                            dbq.update(plan, uc.getUser(), rs.getInt(1));
                                            System.out.println("The plan name has been changed");
                                        } else {
                                            System.out.println("The plan name could not be changed");
                                        }
                                    }
                                    break;
                                case TWO:
                                    ...
                                    if (recipe!=null) {
                                        dbq.deleteFromWeeklyPlan(plan, recipe, uc.getUser(), day);
                                    
                                        plan.removeRecipeFromWeeklyPlan(recipe, day);
